...
export const ASSETS: Record<string, AssetDefinition> = {
  ...
  "platform.square": { kind: "box", dimensions: [11, 0.4, 8], physicsShape: PhysicsShapeType.BOX, mass: 0, model: "/assets/models/platform_square.gltf" },
  "platform.round": { kind: "cylinder", dimensions: [10, 0.4, 10], radius: 5, physicsShape: PhysicsShapeType.CYLINDER, mass: 0, model: "/assets/models/platform_round.gltf" },
