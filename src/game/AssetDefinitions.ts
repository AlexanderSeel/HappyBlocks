...
export const ASSETS: Record<string, AssetDefinition> = {
  ...
  "block.wedge": { kind: "wedge", dimensions: [1.4, 1, 1], physicsShape: PhysicsShapeType.CONVEX_HULL, mass: 1.5, model: "/assets/models/block_wedge.gltf" },
  ...
  "bumper.round": { kind: "cylinder", dimensions: [1.8, 0.42, 1.8], radius: 0.9, physicsShape: PhysicsShapeType.CYLINDER, mass: 4.2, model: "/assets/models/bumper_round.gltf" },
  "platform.square": { kind: "box", dimensions: [80, 0.3, 80], physicsShape: PhysicsShapeType.BOX, mass: 0, model: "/assets/models/platform_square.gltf" },
  "platform.round": { kind: "cylinder", dimensions: [80, 0.3, 80], radius: 40, physicsShape: PhysicsShapeType.CYLINDER, mass: 0, model: "/assets/models/platform_round.gltf" },
